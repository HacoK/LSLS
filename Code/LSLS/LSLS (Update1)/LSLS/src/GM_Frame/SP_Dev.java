 ...
 * @author Kevin
 */
public class SP_Dev extends javax.swing.JFrame {

    /**
     * Creates new form SP_Dev
     */
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        List<sum_p> sps=new ArrayList<sum_p>();
        DefaultTableModel tableModel = (DefaultTableModel) jTable1.getModel();
        int i=0;
        while ((String) tableModel.getValueAt(i, 0)!=null) {
            sum_p sp = new sum_p();
            sp.setSum(Double.parseDouble((String) tableModel.getValueAt(i, 0)));// 取得第i行第一列的数据
            sp.setG_ID((String) tableModel.getValueAt(i, 1));// 取得第i行第二列的数据
            sp.setDiscount(Double.parseDouble((String) tableModel.getValueAt(i, 2)));// 取得第i行第三列的数据
            sp.setVoucher(Double.parseDouble((String) tableModel.getValueAt(i, 3)));// 取得第i行第四列的数据
            sps.add(sp);
            i++;
        }
        try {
            serv.SP_D(Date, duration, sps);
    ...
    public static void run(HacoService serv) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SP_Dev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
