 ...
 * @author qiusheng
 */
public class Overflow extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            serv.OverflowCreate(ID, stb.toString());
    ...
    public static void run(HacoService serv) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Overflow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
