    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount()==2){
            if (jTable1.columnAtPoint(evt.getPoint()) == 0) {
                ChatinStR a = new ChatinStR(StockReturn.this);
                a.run(StockReturn.this);
            }
        }    
...
//            A.addGoods(inputValue, Integer.valueOf(inputValue3));
        ...
        if (p == 1) {
            ...
            try {
                ...
                HacoService serv = (HacoService) namingContext.lookup(
                        url + "HacoService1");
                serv.sendStockReturnForm(A);
            } catch (IOException ex) {
                Logger.getLogger(StockReturn.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void run() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockReturn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void DATA(){
        A.returnForm(IDLB.getText(), RepLB.getText(), Integer.valueOf(OpmanLB.getText()));
    ...
    public void Initialize(){
        ...
        try {
            ...
            HacoService serv = (HacoService) namingContext.lookup(
                    url + "HacoService1");
            IDLB.setText(serv.newStockReturnFormID());
        }
