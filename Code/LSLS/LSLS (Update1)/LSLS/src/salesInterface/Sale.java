...
public class Sale extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(390, 50, 64, 22);
        ...
        SlmanLB.setBounds(450, 50, 90, 22);
        ...
        jLabel5.setBounds(340, 80, 70, 24);
        ...
        OpmanLB.setBounds(620, 50, 27, 22);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount()==2){
            if (jTable1.columnAtPoint(evt.getPoint()) == 0) {
                ChatinSale2 a = new ChatinSale2(Sale.this);
                a.run(Sale.this);
            }
        }    
...
//            A.addGoods(inputValue, Integer.valueOf(inputValue3));
    ...
    public void DATA(){
        A.saleForm(IDLB.getText(), SlmanLB.getText(), RepLB.getText(), Integer.valueOf(OpmanLB.getText()));
    ...
    public void Initialize(){
        ...
        try {
            ...
            HacoService serv = (HacoService) namingContext.lookup(
                    url + "HacoService1");
            IDLB.setText(serv.newSaleFormID());
        }
        catch (Exception e) {}
