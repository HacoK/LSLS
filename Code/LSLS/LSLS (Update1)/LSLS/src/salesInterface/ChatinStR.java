 ...
 * @author 79020
 */
public class ChatinStR extends javax.swing.JFrame {
     ...
     */
    public ChatinStR(StockReturn in) {
        initComponents(in);
    }
    

    // <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    private void initComponents(StockReturn in) {
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt,StockReturn in) {                                     
     ...
     */
    public void run(StockReturn in) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatinStR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChatinStR(in).setVisible(true);
            }
