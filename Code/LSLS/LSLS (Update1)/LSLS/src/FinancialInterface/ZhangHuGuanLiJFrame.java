 ...
 * @author 79020
 */
public class ZhangHuGuanLiJFrame extends javax.swing.JFrame {

    /**
     * Creates new form MainJFrame
     */
    public ZhangHuGuanLiJFrame() {
        initComponents();
        initComponentsb();
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       jPanela3.setBounds(798, 0, 744, 600);
            add(jPanela3);
            Timer timer = new Timer();
                        TimerTask  task = new TimerTask (){
                              int count=36;
                              ...
                              public void run() {
                                   if(count>0){
                                       num+=1;
                                       total+=num;
                                       jPanela3.setLocation(jPanela3.getX()-num, jPanela3.getY());
                                       jPanel1.setLocation(jPanel1.getX()-num, jPanel1.getY());
                                      //jPanela.setSize(width, width);
                                     count--;
                            }else{
                               remove(jPanel1);
                               repaint();
                               jPanela3.add(jPanelID);       
                               jPanela3.add(jPanel2);      
                               jPanela3.repaint();
                               cancel();                          
                             }
                           }
    ...
    public static void run() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZhangHuGuanLiJFrame().setVisible(true);
            }
