 ...
 * @author 79020
 */
public class FuKuanDanJFrame extends javax.swing.JFrame {
     ...
     */
     public  void writeserv() throws RemoteException {
        ...
        try {
            ...
            PbbService serv = (PbbService) namingContext.lookup(
                    url + "HelloService1");
            serv.writeFuKuanDan(in,accountname);
        }
     ...
     public  void writeListserv() throws RemoteException {
        ...
        try {
            ...
            PbbService serv = (PbbService) namingContext.lookup(
                    url + "HelloService1");
            serv.writeFuKuanDanList(list);
        }
        catch (NamingException e) {
            e.printStackTrace();
        }
    }
    String in,accountname;
     String list="";
    public FuKuanDanJFrame() {
        initComponents();
        initComponentsb();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        accountname=jTextField1.getText();
        String totalAmount=jTextField2.getText();
        String time=jLabel11.getText();
       String number="",item = "",amount = "",note = "";
       int line=0;
       ...
       for(int i=0;i<line;i++){
           ...
           item+=(String)jTable1.getValueAt(i, 1)+" ";    
           amount+=(String)jTable1.getValueAt(i, 2)+" ";     
           note+= (String)jTable1.getValueAt(i,3)+" ";
       }
       in=number+"\n"+item+"\n"+amount+"\n"+note+"\n"+" "+totalAmount;
       String check="未审核";
       list=accountname+" "+check+" "+time;
         try {
             writeserv();
         } catch (RemoteException ex) {
             Logger.getLogger(FuKuanDanJFrame.class.getName()).log(Level.SEVERE, null, ex);
         }
         try {
             writeListserv();
         } catch (RemoteException ex) {
    ...
    public static void run() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FuKuanDanJFrame().setVisible(true);
            }
