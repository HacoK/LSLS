 ...
 * @author 79020
 */
public class ZhiDingDanJu1 extends javax.swing.JFrame {
        ...
        if(select=="收款单"){
            ...
            jScrollPane2.setVisible(true);                      
             try {
                 ...
                 Logger.getLogger(ZhiDingDanJu1.class.getName()).log(Level.SEVERE, null, ex);
             }                                
    ...
    public static void run() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZhiDingDanJu1().setVisible(true);
            }
