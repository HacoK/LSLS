...
public class ChangeJPanel extends javax.swing.JPanel {
 ...
 String name;String money;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("修正余额");
        add(jLabel3);
        jLabel3.setBounds(110, 200, 90, 40);
        ...
        add(jTextField2);
        jTextField2.setBounds(260, 200, 270, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         money=jTextField2.getText();
        try {
            changeserv();
        } catch (RemoteException ex) {
            Logger.getLogger(ChangeJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }            
