 ...
 * @author 79020
 */
public class CheckPaymentAndVoucher extends javax.swing.JFrame {
    ...
    public static void run() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckPaymentAndVoucher().setVisible(true);
            }
