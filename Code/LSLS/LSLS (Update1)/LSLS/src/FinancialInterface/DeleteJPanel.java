...
String name;
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(110, 180, 100, 40);
        ...
        add(jTextField1);
        jTextField1.setBounds(270, 180, 270, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     name=jTextField1.getText();
         try {
             ...
             Logger.getLogger(DeleteJPanel.class.getName()).log(Level.SEVERE, null, ex);
         }
