 ...
 */
public class CheckShouKuanDanJPanel extends javax.swing.JPanel {
    ...
    public  String checkShouKuanDan(String name) throws RemoteException {
      ...
      public  String viewShouKuanDanlist() throws RemoteException {
        String url = "rmi://localhost:1098/";
        String out="";
        try {
            Context namingContext = new InitialContext();
      ...
      public  void writeListserv() throws RemoteException {
        ...
        try {
            ...
            PbbService serv = (PbbService) namingContext.lookup(
                    url + "HelloService1");
            serv.changeShouKuanDanList(list);
        }
        catch (NamingException e) {
            e.printStackTrace();
        }
...
String list="";
    public CheckShouKuanDanJPanel(String name,String time) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(CheckShouKuanDanJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }      
        
        
            String readOut="";
        try {
            readOut = viewShouKuanDanlist();
            ...
            try {
                 ...
                 Logger.getLogger(CheckPaymentAndVoucher.class.getName()).log(Level.SEVERE, null, ex);
             }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("客户");
        add(jLabel6);
        jLabel6.setBounds(80, 180, 60, 25);
        ...
        add(jLabel13);
        jLabel13.setBounds(160, 180, 150, 25);
