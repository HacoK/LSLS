...
import static ClassManagement.DelClassInfo.f;
 ...
 * @author qiusheng
 */
public class ModClassInfo extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        GoodsClass contents=new GoodsClass();
        contents.ID=(String)(tableModel.getValueAt(1,0));
        contents.name=(String)(tableModel.getValueAt(1,1));
        gsc.add(contents);
        try {
            serv.classSearch(f,true);
            serv.AddGoodsClass(gsc);
        } catch (Exception ex) {
            Logger.getLogger(ModClassInfo.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
        Class.run(serv);
    ...
    public static void run(HacoService serv,String f) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModClassInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        ModClassInfo.serv=serv;
        ModClassInfo.f=f;
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModClassInfo().setVisible(true);
            }
        });
    }
