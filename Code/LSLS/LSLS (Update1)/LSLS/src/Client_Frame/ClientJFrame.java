...
public class ClientJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                " 客户ID", " 类型", " 级别", " 名字", " 联系方式", " 地址", " 邮编", " eMail", " 应收额度", " 应收", " 应付"
            }
        ));
        ...
        jPanel1.setBounds(60, 0, 1100, 600);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        ClientNew.edit=true;
        try {
            content = serv.clientSearch((String) tableModel.getValueAt(selectedRowIndex, 0),false);
            serv.clientSearch((String) tableModel.getValueAt(selectedRowIndex, 0),true);
        } catch (Exception ex) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (selectRows == 1) {
            int selectedRowIndex = jTable1.getSelectedRow();
            try {
                String result = serv.clientSearch((String) tableModel.getValueAt(selectedRowIndex, 0),true);
            ...
            for (int i = 0; i < selRowIndexs.length; i++) {
                ...
                try {
                    serv.clientSearch(cellValue,true);
                } catch (RemoteException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public static void run(HacoService serv,String name,String ID) {
        ...
        ClientJFrame.serv=serv;
        ClientJFrame.name=name;
        ClientJFrame.ID=ID;
